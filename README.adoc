...
- link:https://app.codacy.com[Qualité du Code]
- link:https://www.bigocheatsheet.com/[Compléxité Algorithmique]
- link:https://ideone.com[Temps d'éxecution]
- link:https://ideone.com[Consommation en ressources]
